...
class EmailSender(EmailSenderInterface):
    def __init__(
        ...
        moderator_alert_email_template_name: str,
    ):
        ...
        self._moderator_alert_email_template_name = moderator_alert_email_template_name
    ...
    async def send_moderator_alert_email(self, email: str, subject: str, message: str) -> None:
        template = self._env.get_template(self._moderator_alert_email_template_name)
        html_content = template.render(email=email, subject=subject, message=message)
        await self._send_email(email, subject, html_content)
